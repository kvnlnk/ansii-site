/**
 * Footer section — GitHub link, MIT license, and retro decoration.
 */
    ...
    <footer className="footer" role="contentinfo" aria-label="Site footer">
      <div className="container">
        <div className="footer__deco" aria-hidden="true">
          <span className="ansi-block ansi-block--dim">
            ░░░▒▒▒▓▓▓███ ansii ███▓▓▓▒▒▒░░░
          </span>
        </div>
        ...
        <div className="footer__inner">
          <div className="footer__links">
            ...
            <span className="footer__license">MIT License</span>
            <span className="footer__separator" aria-hidden="true">|</span>
          ...
          <p className="footer__copyright">
            &copy; {new Date().getFullYear()} kvnlnk. Built with Rust and ANSI spirit.
          </p>
        </div>
      </div>
    </footer>
